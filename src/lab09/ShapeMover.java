                                                  ...
                                                  Runnable
{
    ...
    public ShapeMover ()
    {
    	...
    	shapes = new Shape[]
    	    {
    	       new Rect    (130,  40,  60, 100, Color.RED),
               new Rect    (230,  40,  20, 30, Color.BLUE),
               new Rect    (330,  40,  80, 60, Color.GREEN.darker()),
               new Rect    (130, 140, 100, 250, new Color (0.8f, 0.6f, 0.2f)),
    	       new Rect    ( 30, 140,  40, 10, Color.YELLOW),
               new Circle  ( 30,  40,  40, Color.ORANGE)
    	    };
    ...
    public void run ()
    {
        JFrame f = new JFrame("Shape Mover 2023");
